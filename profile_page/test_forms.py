'''
tests for profile_page app forms
'''
...
class TestProfileUpdateForm(TestCase):
    '''
    tests:
    - test_profile_form_is_valid
    - test_profile_form_is_not_valid
    - test_user_form_is_valid_without_email
    - test_user_form_is_valid_with_email
    - test_user_form_is_not_valid
    '''
    def test_profile_form_is_valid(self):
        ...
        self.assertTrue(form.is_valid(),
                        msg='Display name was provided,but form is not valid')
    ...
    def test_profile_form_is_not_valid(self):
        ...
        form = ProfileUpdateForm(
            {'about_me': 'Blah Blah Blah', 'display_name': ''})
        self.assertFalse(
            form.is_valid(),
            msg='Display name was not provided, but the form is valid'
            )
    ...
    def test_user_form_is_valid_without_email(self):
        ...
        self.assertTrue(
            form.is_valid(),
            msg='Email was blank, but form is not valid'
            )
    ...
    def test_user_form_is_valid_with_email(self):
        ...
        self.assertTrue(
            form.is_valid(),
            msg='Email was valid, but form is not valid'
            )
    ...
    def test_user_form_is_not_valid(self):
        ...
        self.assertFalse(
            form.is_valid(),
            msg='Email was invalid, but the form is valid'
            )
