# Generated by Django 4.2.14 on 2024-07-22 18:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='message_board.post')),
            ],
            options={
                'ordering': ['created_on'],
            },
