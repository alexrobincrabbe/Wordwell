...
class TestProfileUpdateForm(TestCase):
    ...
    def test_post_form_is_valid(self):
        ...
        self.assertTrue(form.is_valid(), msg='Mandatory fields were provided, but form is not valid')
    ...
    def test_post_form_is_not_valid(self):
        ...
        self.assertFalse(form.is_valid(), msg='Title was not provided, but the form is valid')
        form = PostForm({'title': 'textTitle','text':''})
        self.assertFalse(form.is_valid(), msg='Text was not provided, but the form is valid')
