...
3.  <details open>
    ...
    <li>
    <summary><a href="#instructions-app-tests">Instructions App Tests</a></summary>
...
| Signup | ![screenshot](readme_files/testing/validation/html/signup.png) | errors are from HTML generated by the Django-allauth template, not in my custom code|
...
| Guess box | Shows a "dictionary loading message" when the dictionary is loading. Shows "press start" when the game is ready to start. Shows "start typing" when the game has started. The word is shown as the player types | Works as expected | <img width="200px" src="readme_files/images/guess_word_loading.png"> <img width="200px" src="readme_files/images/guess_word_start.png"> <img width="200px" src="readme_files/images/guess_word_type.png"> <img width="200px" src="readme_files/images/guess_word_guess.png"> |
| Guess confirmation messages | When the player presses enter: the word and score are shown if the word is valid, a message is shown that the word is invalid if it is not on the board or not in the dictionary, if the word has already been guessed, a message is shown that the word has already been guessed | Works as expected| <img width="200px" src="readme_files/images/test_valid.png"> <img width="200px" src="readme_files/images/test_invalid.png"> <img width="200px" src="readme_files/images/test_guessed.png"> |
...
| Save score button | The score is saved to the database, a confirmation message is shown|  Works as expected |  <img width="200px" src="readme_files/images/test_save.png"> |
...
| Feature | Expectation | Result | Screenshot | 
| --- | --- | --- | --- |
| Form | Submits only if: the display name has been completed, is unique and the email is valid (if given) | Works as expected | |
...
| Feature | Expectation | Result | Screenshot | 
| --- | --- | --- | --- |
| List of high scores | Shows all registered users, ordered by highscore. Display name and profile picture are shown for each user. The display name links to the profile of the user | Works as expected | <img width="200px" src="readme_files/images/test_high_scores.png"> |
...
| Replies | All replies are shown beneath the post, with the oldest at the top. The name, text and creation date of each post are shown| Works as expected | <img width="200px" src="readme_files/images/test_view_replies.png"> |
...
| Feature | Expectation | Result | Screenshot | 
| --- | --- | --- | --- |
| Login link | The link is shown, and the user is directed to the login page when it is clicked | Link works as expected | <img width="200px" src="readme_files/images/test_login_homepage.png"> |
...
- Checks that the page loads correcty
- Checks that all usernames and high scores are displayed on the page
- Checks that the context data is correctly ordered
...
- Tests form validates if mandatory fields are complete and the email is valid
...
<img src="readme_files/images/resposive_board.png" height=300px>
<img src="readme_files/images/resposive_profile.png" height=300px>
<img src="readme_files/images/resposive_highscores.png" height=300px>
</div>
